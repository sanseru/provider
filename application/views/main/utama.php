              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable2" width="100%" cellspacing="0">
                  ...
                  <?php
                    ...
                    <tr>
                      <td><?php echo $no++; ?></td>
                      <td><a href="<?php echo site_url('Welcome/history/'.$row->id_rumahsakit);?>"><i class="fa fa-pencil"></i> <?php echo $row->nm_rs; ?></td>
                      <td><?php echo $row->notes; ?></td>
                      <td><a class="btn btn-success btn-circle btn-xs" href="<?php echo site_url('Welcome/update/'.$row->id_rumahsakit);?>" onclick="return confirm('Apakah Yakin Provider Ini sudah Selesai Status Follow Up Nya ?')"> <i class="fas fa-check"></i></a></td>
